...
Checkout the [Leaderboard.md](https://github.com/LucasRodriguesOliveira/path-of-code/blob/main/Challenges/challenge-001-sorting_algorithms/Leaderboard.md) for a explanation about how scoring works.
